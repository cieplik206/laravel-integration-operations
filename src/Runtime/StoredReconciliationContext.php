...
/** @internal */
final readonly class StoredReconciliationContext implements ReconciliationContext
{
    ...
    {
        throw new LogicException('Stored reconciliation contexts cannot be serialized.');
    }

    public function __clone(): void
    {
        throw new LogicException('Stored reconciliation contexts cannot be cloned.');
    }
}
