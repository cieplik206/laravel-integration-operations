...
final readonly class CircuitDecision
{
    private function __construct(
        private ?CircuitCallPermit $permit,
        ...
        if (($permit === null) === ($rejection === null)
            ...
            throw new InvalidArgumentException('Circuit decision is invalid.');
        }
    }

    public static function allow(CircuitCallPermit $permit): self
    {
    ...
    public function permit(): ?CircuitCallPermit
    {
        return $this->permit;
    }
